...
export const TRANSLATIONS = {
  ...
  en: {
    ...
    bypassDesc: 'Clear cookies and reload tab',
    ...
    statusBypassDone: 'Cleared {cookies} cookies. Reloading...',
